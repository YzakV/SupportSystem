...
$sql = "UPDATE reporte SET calidad = '$calidad', atencion = '$atencion', nivel = '$nivel', tiempo = '$tiempo', solucion ='$solucion', Firma = '$direccion', status = '$status' WHERE id_reporte ='$num'";
