...
//verificar conexion
  ...
  $salida="";
  $query="SELECT * FROM teclado ORDER By id_teclado";
  if (isset($_POST['consulta'])) {
  $q = $conectar->real_escape_string($_POST['consulta']);
  $query = "SELECT id_teclado, marca, modelo, serie FROM teclado
  WHERE id_teclado LIKE '%".$q."%' OR marca LIKE '%".$q."%' OR modelo LIKE '%".$q."%' OR serie LIKE '%".$q."%'";
}//
