...
<body>
  ...
  <form class="" action="save.php" method="post">
    <div class="equipo">
    <label for="id-cargador">ID Teclado</label>
    <input class="" type="text" id="id-cargador-c" name="id-t" >

    <label for="marca">Marca</label>
    <input class="" type="text" id="marca-c" name="marca-t" >

    <label for="modelo">Modelo</label>
    <input class="" type="text" id="modelo-c" name="modelo-t" >

    <label for="serie">Serie</label>
    <input class="" type="text" id="serie-c" name="serie-t" ><!--Cargador-->
  ...
  <form class="" action="del.php" method="post">
    <div class="equipo">
      ...
      <input class="form-control" type="text" id="id-t" name="id-t" >
