...
//verificar conexion
  ...
  $salida="";
  $query="SELECT * FROM bocinas ORDER By id_bocinas";
  if (isset($_POST['consulta'])) {
  $q = $conectar->real_escape_string($_POST['consulta']);
  $query = "SELECT id_bocinas, marca, modelo, serie FROM bocinas
  WHERE id_bocinas LIKE '%".$q."%' OR marca LIKE '%".$q."%' OR modelo LIKE '%".$q."%' OR serie LIKE '%".$q."%'";
}//
