...
<body>
  ...
  <form class="" action="save.php" method="post">
    <div class="equipo">
    <label for="id-cargador">ID Bocinas</label>
    <input class="" type="text" id="id-cargador-c" name="id-b" >

    <label for="marca">Marca</label>
    <input class="" type="text" id="marca-c" name="marca-b" >

    <label for="modelo">Modelo</label>
    <input class="" type="text" id="modelo-c" name="modelo-b" >

    <label for="serie">Serie</label>
    <input class="" type="text" id="serie-c" name="serie-b" ><!--Cargador-->
  ...
  <form class="" action="del.php" method="post">
    <div class="equipo">
      ...
      <input class="form-control" type="text" id="id-b" name="id-b" >
