...
<body>
  ...
  <form class="" action="save.php" method="post">
    <div class="equipo">
    <label for="id-cargador">ID Mouse</label>
    <input class="" type="text" id="id-m" name="id-m" >

    <label for="marca">Marca</label>
    <input class="" type="text" id="marca-c" name="marca-m" >

    <label for="modelo">Modelo</label>
    <input class="" type="text" id="modelo-c" name="modelo-m" >

    <label for="serie">Serie</label>
    <input class="" type="text" id="serie-c" name="serie-m" ><!--Cargador-->
  ...
  <form class="" action="del.php" method="post">
    <div class="equipo">
      ...
      <input class="form-control" type="text" id="id-m" name="id-m" >
