...
//verificar conexion
  ...
  $salida="";
  $query="SELECT * FROM cargador ORDER By id_cargador";
  if (isset($_POST['consulta'])) {
  $q = $conectar->real_escape_string($_POST['consulta']);
  $query = "SELECT id_cargador, marca, modelo, serie FROM cargador
  WHERE id_cargador LIKE '%".$q."%' OR marca LIKE '%".$q."%' OR modelo LIKE '%".$q."%' OR serie LIKE '%".$q."%'";
}//
