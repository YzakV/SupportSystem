...
<body>
  ...
  <form class="" action="save.php" method="post">
    <div class="equipo">
    <label for="id-cargador">ID No-brake</label>
    <input class="" type="text" id="id-cargador-c" name="id-nb" >

    <label for="marca">Marca</label>
    <input class="" type="text" id="marca-c" name="marca-nb" >

    <label for="modelo">Modelo</label>
    <input class="" type="text" id="modelo-c" name="modelo-nb" >

    <label for="serie">Serie</label>
    <input class="" type="text" id="serie-c" name="serie-nb" ><!--Cargador-->
  ...
  <form class="" action="del.php" method="post">
    <div class="equipo">
      ...
      <input class="form-control" type="text" id="id-nb" name="id-nb" >
