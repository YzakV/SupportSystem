...
//verificar conexion
  ...
  $salida="";
  $query="SELECT * FROM monitor ORDER By id_monitor";
  if (isset($_POST['consulta'])) {
  $q = $conectar->real_escape_string($_POST['consulta']);
  $query = "SELECT id_monitor, marca, modelo, serie FROM monitor
  WHERE id_monitor LIKE '%".$q."%' OR marca LIKE '%".$q."%' OR modelo LIKE '%".$q."%' OR serie LIKE '%".$q."%'";
}//
